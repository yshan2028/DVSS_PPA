...
class SensitivityService:
    ...
    def __init__(self, field_dao: FieldDAO):
        ...
        self.pii_patterns = {
            ...
            'address': r'\b\d+\s+[\w\s]+(?:st|street|ave|avenue|rd|road|blvd|boulevard|dr|drive|ln|lane|ct|court|pl|place)\b'
        }
    ...
    async def _analyze_field_name_sensitivity(self, field_name: str) -> float:
        ...
        high_sensitivity_keywords = [
            ...
            'credit', 'debit', 'account', 'routing', 'bank', 'payment',
            'medical', 'health', 'diagnosis', 'prescription', 'treatment',
            'biometric', 'fingerprint', 'facial', 'retina', 'voice'
        ]
        
        medium_sensitivity_keywords = [
            'name', 'phone', 'email', 'address', 'location', 'contact',
            'birth', 'age', 'gender', 'marital', 'occupation', 'company',
            'salary', 'income', 'education', 'religion', 'ethnicity'
        ]
        
        low_sensitivity_keywords = [
            'id', 'number', 'code', 'reference', 'status', 'type',
            'date', 'time', 'amount', 'quantity', 'description', 'notes'
        ]
