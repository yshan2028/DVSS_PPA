    ...
    async def get_system_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'database': {'user_count': user_count, 'order_count': order_count, 'shard_count': shard_count},
                'activity': {'today_operations': len(today_logs), 'last_updated': datetime.now().isoformat()},
            }
