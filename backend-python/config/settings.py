...
class Settings(BaseSettings):
    ...
    # 数据库配置
    DATABASE_URL: str = 'mysql+asyncmy://root:admin123@mysql:3306/dvss_db'
    DATABASE_ECHO: bool = False
    DATABASE_POOL_SIZE: int = 10
    DATABASE_MAX_OVERFLOW: int = 20

    # MongoDB配置
    MONGODB_URL: str = 'mongodb://root:admin123@mongo:27017'
    MONGODB_DATABASE: str = 'dvss_db'

    # Redis配置
    REDIS_URL: str = 'redis://:admin123@redis:6379/0'
    REDIS_PASSWORD: Optional[str] = 'admin123'
    REDIS_DB: int = 0
    ...
    # Go后端配置
    GO_BACKEND_URL: str = 'http://backend-go:8001'
